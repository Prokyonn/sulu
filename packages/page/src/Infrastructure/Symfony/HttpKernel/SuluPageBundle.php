...
use Sulu\Page\Infrastructure\Sulu\Content\ContentResolver\PageLinkContentPreResolveEnhancer;
...
final class SuluPageBundle extends AbstractBundle
{
    ...
    public function loadExtension(array $config, ContainerConfigurator $container, ContainerBuilder $builder): void
    {
        ...
        // Content Pre Resolve Enhancer service
        $services->set('sulu_page.page_link_content_pre_resolve_enhancer')
            ->class(PageLinkContentPreResolveEnhancer::class)
            ->args([
                new Reference('sulu_page.page_repository'),
                new Reference('sulu_content.content_aggregator'),
                new Reference('sulu_markup.link_tag.provider_pool'),
            ])
            ->tag('sulu_content.content_pre_resolve_enhancer');
