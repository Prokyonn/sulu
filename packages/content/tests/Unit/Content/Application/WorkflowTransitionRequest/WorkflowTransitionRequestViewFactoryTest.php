...
class WorkflowTransitionRequestViewFactoryTest extends TestCase
{
    ...
    public function testChecksAndApprovalsAreSerializedAsTwoLists(): void
    {
        ...
        $request->addApproval($this->user(2, 'Reviewer A'), DecisionMessage::text('Fine by me'));
        $request->addRejection($this->user(3, 'Reviewer B'), DecisionMessage::text('Please fix the intro'));
