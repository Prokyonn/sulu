...
{
    public const REASON_NO_REQUEST = 'no_request';
    ...
    public static function noRequest(?\Throwable $previous = null): self
    {
        return new self(
    ...
    public static function notApproved(?\Throwable $previous = null): self
    {
        return new self(
