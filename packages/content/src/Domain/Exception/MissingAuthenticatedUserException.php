 ...
 * security token storage does not provide one. Mapped to HTTP 401 by
 * {@see \Sulu\Content\UserInterface\EventListener\WorkflowTransitionRequestExceptionListener}.
 */
