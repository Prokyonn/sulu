...
if ($trustedProxies = $_SERVER['TRUSTED_PROXIES'] ?? false) {
    Request::setTrustedProxies(\explode(',', (string) $trustedProxies), Request::HEADER_X_FORWARDED_FOR | Request::HEADER_X_FORWARDED_PORT | Request::HEADER_X_FORWARDED_PROTO); // @phpstan-ignore-line argument.type
}
...
if (\preg_match('/^\/admin(\/|$)/', (string) $_SERVER['REQUEST_URI'])) {  // @phpstan-ignore-line argument.type
