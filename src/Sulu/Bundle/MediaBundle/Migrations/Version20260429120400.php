...
/**
 * MediaType denormalization, step 1 of 2: adds `me_media.type` (nullable) and populates it from
 * the legacy `me_media_types.name`. Step 2 drops the legacy table/column and flips `type` to
 * NOT NULL.
 */
final class Version20260429120400 extends AbstractMigration
{
    ...
    {
        return 'MediaType denormalization (1/2): add me_media.type column and populate it from me_media_types.name';
    }
