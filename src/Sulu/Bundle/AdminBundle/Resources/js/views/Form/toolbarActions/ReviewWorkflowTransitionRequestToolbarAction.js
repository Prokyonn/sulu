...
export default class ReviewWorkflowTransitionRequestToolbarAction extends AbstractFormToolbarAction {
    ...
    // The form is locked while a request is open, so there is nothing to validate and the server
    // discards the payload anyway; what goes live is what the reviewers saw.
    handlePublish = () => {
        this.handleClose();
